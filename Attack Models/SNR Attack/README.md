...
`mycorr.m`, `myin.m` and `WS1.mat` are some accessory files for the necessary implementation of the analysis. `SNR_PLOT_BYTE-1.fig` is a sample figure expected for the SNR analysis of byte no. 1 of AES secret key.